    ...
    <div class="bg-white py-12 sm:py-16">
        <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
            <div v-if="singers.length > 0">
                ...
                <ul role="list"
                    ...
                    <li v-for="singer in singers" :key="singer.id"
                        ...
                        <h3 class="mt-2 text-center text-sm font-medium text-gray-800 sm:text-base group-hover:text-emerald-700">{{ singer.name }}</h3>
            ...
            <div v-else class="mx-auto max-w-2xl">
                ...
                <button @click="navigateToDiscoverSingers" class="mt-8 px-4 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition duration-300">
                    发现歌手
                </button>
            </div>
        </div>
