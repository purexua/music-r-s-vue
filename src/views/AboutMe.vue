        ...
        <div class="relative mx-auto -mt-32 max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex items-start space-x-8">
                ...
                <div class="max-w-xl flex-auto">
                    <h3 class="text-3xl font-semibold leading-8 tracking-tight text-gray-900">{{ userInfo.username }}
                    </h3>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-16">
            ...
            <div class="hidden sm:block">
                <nav class="isolate flex divide-x divide-gray-200 rounded-lg shadow" aria-label="Tabs">
                    <RouterLink v-for="(tab, tabIdx) in tabs" :key="tab.index" :to="tab.href" :class="[isCurrentTab(tab) ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700',
                    ...
                    tabIdx === tabs.length - 1 ? 'rounded-r-lg' : '',
                        ...
                        <span aria-hidden="true"
                            :class="[isCurrentTab(tab) ? 'bg-indigo-500' : 'bg-transparent', 'absolute inset-x-0 bottom-0 h-0.5']" />
                    </RouterLink>
                </nav>
            </div>
            <div class="mt-10">
